...
/// <summary>
/// Provides the primary container of the various contexts that make up the Bad Echo Extensibility framework.
/// </summary>
internal sealed class PluginStore : IDisposable
{
    ...
    /// </returns>
    /// <remarks>This is an entry point into the Bad Echo Extensibility framework's call-routable plugin system.</remarks>
