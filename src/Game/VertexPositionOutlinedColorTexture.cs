...
public readonly struct VertexPositionOutlinedColorTexture : IVertexType, IEquatable<VertexPositionOutlinedColorTexture>
{
    ...
    {
        var position = new VertexElement(0, VertexElementFormat.Vector3, VertexElementUsage.Position, 0);
        var fillColor = new VertexElement(12, VertexElementFormat.Color, VertexElementUsage.Color, 0);
